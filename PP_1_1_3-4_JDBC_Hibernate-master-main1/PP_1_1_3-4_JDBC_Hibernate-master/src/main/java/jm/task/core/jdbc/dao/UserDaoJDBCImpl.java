...
public class UserDaoJDBCImpl implements UserDao {
    ...
    public void saveUser(String name, String lastName, byte age) {
        ...
        try (Connection connection = Util.getConnection(); PreparedStatement preparedStatement = connection.prepareStatement(save)) {
    ...
    public void removeUserById(long id) {
        ...
        try (Connection connection = Util.getConnection(); PreparedStatement preparedStatement = connection.prepareStatement(remove)) {
